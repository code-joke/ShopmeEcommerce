package com.shopme.admin.test.category;
...
public class CategoryRepositoryTests {
	...
	// test hierarchical category using recursive algorithm
	// using printChildren method to list level category get by parent parsing cat level
	// 
	@Test
